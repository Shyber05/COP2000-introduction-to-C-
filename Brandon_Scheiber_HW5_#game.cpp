...
int main(){
    ...
    int ansBoard[3] = {14, 15, 8};      //Array that stores the answer for each board
    int playedBoard[3] = {NULL};        //Array that will keep track of which boards have been played
    int ans;                            //Variable that will store the users answer
    ...
    do{
        ...
        do{
            ...
            if(winner){
                ...
                // this will keep track of how many wins the user has as well
                // as the boards that have been played
                ...
                // this is adds for each guess made
                guessCount += 1;
            }
...
// this function will choose a random board for the 
// beginning of the game or to restart the game 
int beginGame(int playedBoard[]){
    ...
    do{
           ...
           randomNum = (rand() % (maxValue - minValue + 1)) + minValue;
            ...
            // check to see if this board has not been played i.e == NULL then
...
void instructions(){
    ...
    cout << "                  Program Developed by: \"Brandon Schieber\"                           \n";
    cout << "***************************************************************************************\n\n";
